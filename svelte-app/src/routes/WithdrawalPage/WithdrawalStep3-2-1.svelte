<script>
  ...
  <div class="page-container">
    <h3 class="page-title">수량 100 이상 개인</h3>
    ...
    <div class="withdrawal-section">
      ...
      <div class="radio-section">
        <span class="withdrawal-name">수취인 성명</span>
        <div class="radio-buttons">
          ...
          <label for="radio-coporate" class="radio-label">
              <input type="radio" class="name-radio" value="법인" onclick="return(false)" />법인
          </label>
        </div>
      </div>
      <input
